...
//	printf("ielem=%d,Gauss=%d\n",ielem,igauss);
//	getchar();
//	offset=geo_dat_size*nr_elem_mic+ielem*nr_coeff;
//
//	printf("diffusion coeff : %lf %lf %lf\n",el_data_in[offset+0],el_data_in[offset+1],el_data_in[offset+2]);
//	printf("diffusion coeff : %lf %lf %lf\n",el_data_in[offset+3],el_data_in[offset+4],el_data_in[offset+5]);
//	printf("diffusion coeff : %lf %lf %lf\n",el_data_in[offset+6],el_data_in[offset+7],el_data_in[offset+8]);
//	printf("convection coeff: %lf %lf %lf\n",el_data_in[offset+9],el_data_in[offset+10],el_data_in[offset+11]);
//	printf("reaction coeff  : %lf\n",el_data_in[offset+15]);
//
//	printf("vol=%lf\n",vol);
...
#pragma ivdep
			...
			for(i=0;i<3;i++)
			  ...
			  //printf("Shp_fun_u=%lf,fun_u_derx=%lf,fun_u_dery=%lf,fun_u_derz=%lf\n",shp_fun_u,fun_u_derx,fun_u_dery,fun_u_derz);
			  //getchar();
...
#pragma ivdep
		...
		//printf("Shp_fun_v=%lf,fun_v_derx=%lf,fun_v_dery=%lf,fun_v_derz=%lf\n",shp_fun_v,fun_v_derx,fun_v_dery,fun_v_derz);
...
//printf("vol=%lf\n",vol);
	...
	//-------------------------------------------------------------
if(ielem==0 && idof==74 && jdof==24)
	printf("igauss=%d, idof=%d, jdof=%d, temp4=%lf,fun_v_derx=%lf,temp5=%lf,fun_v_dery=%lf,temp6=%lf,fun_v_derz=%lf,temp7=%lf,shp_fun_v=%lf, vol=%lf \n",igauss, idof,jdof, temp4,fun_v_derx,temp5,fun_v_dery,temp6,fun_v_derz,temp7,shp_fun_v,vol);
	//printf("igauss=%d, idof=%d, jdof=%d, stiff_mat[%d]=%lf \n",igauss, idof,jdof,jdof*NDOFS+idof,stiff_mat[jdof*NDOFS+idof]);
		}//jdof
