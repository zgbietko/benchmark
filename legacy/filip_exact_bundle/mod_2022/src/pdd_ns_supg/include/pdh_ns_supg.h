...
Contains declarations of routines:
 ...
 (functions called by other modules are in pdh_ns_supg_problem.h)
  ...
  pdr_ns_supg_error - to compute estimated norm of error (in adapt) 
...
/**--------------------------------------------------------
pdr_ns_supg_error - to compute estimated norm of error based on 
                 recovered first derivatives - the notorious ZZ error estimate
---------------------------------------------------------*/
extern double pdr_ns_supg_error(
  char* Work_dir,
  FILE *Interactive_input, 
  FILE *Interactive_output);
