#ifndef KazFILEEXPORTER_H
#define KazFILEEXPORTER_H
...
class KazFileExporter : public MeshFileWriter
{
    public:
        KazFileExporter();
        KazFileExporter(const std::string & file_name);
        virtual ~KazFileExporter();
