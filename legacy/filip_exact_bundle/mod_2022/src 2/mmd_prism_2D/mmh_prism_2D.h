...
extern int mmr_divide_el4_p( /* returns: >=0 - success code, <0 - error code */
  int Mesh_id,    /* in: mesh ID or 0 (MMC_CUR_MESH_ID) for the current mesh */
  int El        /* in: element ID */
);

extern int mmr_clust_el4_p( /* returns: >=0 - success code, <0 - error code */
  int Mesh_id,    /* in: mesh ID or 0 (MMC_CUR_MESH_ID) for the current mesh */
  int El        /* in: element ID */
);
...
extern int mmr_divide_face2_q(/* returns: >=0 - success code, <0 - error code */
  int  Mesh_id,	   /* in: mesh ID or 0 (MMC_CUR_MESH_ID) for the current mesh */
  int  Fa,         /* in: face to be divided */ 
...
extern int mmr_clust_fa2_q( /* returns: >=0 - success code, <0 - error code */
  int  Mesh_id,	/* in: mesh ID or 0 (MMC_CUR_MESH_ID) for the current mesh */
  int Face,      /* in: face ID */
  int* Face_sons /* in (optional): face sons' IDs */
);
