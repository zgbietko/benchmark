...
/*kbw
  printf("before calling lar_allocate_SM_and_LV: solver %d, level %d\n",
	 Solver_id, Level_id);
...
/*kbw
  printf("before calling lar_initialize_SM_and_LV: solver %d, level %d, comp_type %d\n",
...
/*kbw
  {
    ...
    printf("before calling lar_assemble_SM_and_LV: solver %d, level %d, comp_type %d, rewr_dofs %c\n",
