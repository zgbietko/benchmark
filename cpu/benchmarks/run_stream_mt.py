...
DEFAULT_SIZES_MB = [64, 256, 1024]  # per-array size (multi-thread tends to be heavier)
...
def main():
    ...
    ap.add_argument("--device-threads", type=str, default="", help="Lista wątków, np. 1,2,4,8 (domyślnie: 1,2,4,8)")
    args = ap.parse_args()
