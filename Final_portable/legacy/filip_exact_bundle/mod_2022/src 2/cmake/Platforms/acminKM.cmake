...
# TODO: ACML, PARMETIS
#set(CMAKE_INCLUDE_PATH ${CMAKE_INCLUDE_PATH} /home/kmichalik/parmetis/include)
#set(CMAKE_LIBRARY_PATH ${CMAKE_LIBRARY_PATH} /home/kmichalik/parmetis/lib)

# TODO: PARALLEL BUILD (MPI)
#set(CMAKE_INCLUDE_PATH ${CMAKE_INCLUDE_PATH} /home/kmichalik/parmetis/include)
set(CMAKE_LIBRARY_PATH ${CMAKE_LIBRARY_PATH} /opt/intel/impi/4.1.0.024/intel64/lib /opt/gnu/gcc/lib)
