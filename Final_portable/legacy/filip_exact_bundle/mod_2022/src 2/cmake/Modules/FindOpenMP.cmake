...
# Modified by Cenaero:
# If a system FindOpenMP.cmake exists, use that one.
# Otherwise, use a simplified version working with cmake 2.6-patch 1

if (EXISTS ${CMAKE_ROOT}/Modules/FindOpenMP.cmake)
...
if ( ${CMAKE_CXX_COMPILER_ID} STREQUAL Intel)
  set(OpenMP_C_FLAG_CANDIDATES "-openmp")
elseif( ${CMAKE_CXX_COMPILER_ID} STREQUAL MSVC)  # CMAKE_CXX_COMPILER_ID not defined if no enalble_language(Fortran)
  set(OpenMP_C_FLAG_CANDIDATES "/openmp")
else()
  set(OpenMP_C_FLAG_CANDIDATES "-fopenmp")
endif()
