...
#include "../../pdd_heat/include/pdh_heat_weakform.h"  	/* USES */
...
/*++++++++++++++++ executable statements ++++++++++++++++*/
  ...
  printf("WRONG FIELD_ID MANAGEMENT IN NS_SUPG_HEAT FOR PARALLEL EXCHANGE TABLES!\n");
  exit(-1);

  // ns_supg - different field_id than heat !!!! for exchange_tables
...
/*kew */
  ...
  field_id = pdr_ctrl_i_params(Problem_id, 3);
  /* definitions of both functions below in this file */
  ...
  )
{
  ...
  pdv_ns_supg_heat_timer_pdr_comp_el_stiff_mat += time_clock() - timer;
  ...
  )
{
  ...
  pdv_ns_supg_heat_timer_pdr_comp_fa_stiff_mat += time_clock() - timer;
