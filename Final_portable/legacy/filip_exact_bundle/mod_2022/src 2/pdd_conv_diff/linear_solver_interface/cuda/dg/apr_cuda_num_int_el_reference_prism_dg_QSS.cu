...
__global__ void tmr_cuda_num_int_el(
  ...
  //const int nr_work_groups = blockDim.x;
...
//	    if(group_id==42 && ielem==0)
//	    {
//	    	printf("Inside stiff_mat_out[%d]=%lf\n",offset+i*WORK_GROUP_SIZE+thread_id,stiff_mat_out[offset+i*WORK_GROUP_SIZE+thread_id]);
//	    }
