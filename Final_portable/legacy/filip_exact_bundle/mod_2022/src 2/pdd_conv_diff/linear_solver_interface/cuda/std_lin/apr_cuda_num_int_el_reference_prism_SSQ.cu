...
//***** SEPARATE COMPUTING OF ALL GLOBAL DERIVATIVES OF ALL SHAPE FUNCTIONS *****//
 ...
 //************ loop for computing ALL shape function values at integration point **********//
	...
	workspace[thread_id*(3*num_shap+PADDING)+3*idof2]   = temp1*jac_0+temp2*jac_3+temp3*jac_6;
	workspace[thread_id*(3*num_shap+PADDING)+3*idof2+1] = temp1*jac_1+temp2*jac_4+temp3*jac_7;
	workspace[thread_id*(3*num_shap+PADDING)+3*idof2+2] = temp1*jac_2+temp2*jac_5+temp3*jac_8;
