...
//#pragma loop_count (6)
	    for(igauss = 0; igauss < NGAUSS; igauss++){
	      ...
	      SCALAR vol = gauss_dat_host[3*NGAUSS+igauss]; // vol = weight
...
//	      } // end loop over shape functions for which global derivatives were computed
	...
	//***** SUBSTITUTING ACTUAL COEFFICIENTS FOR SM AND LV CALCULATIONS *****//
	      ...
	      SCALAR temp[4][STRIDE] __attribute__((aligned(ALIGN)));;
...
//	#endif // COMPUTE_ALL_SHAPE_FUN_DER
	...
	//*** ACTUAL INTERMEDIATE CALCULATIONS FOR IDOF SHAPE FUNCTION ***//
	  	  ...
	  	  temp[0][0:STRIDE] = coeff00*tab_fun_u_derx[0:STRIDE] + coeff01*tab_fun_u_dery[0:STRIDE] + coeff02*tab_fun_u_derz[0:STRIDE];// + coeff03*shp[0:STRIDE];
		  temp[1][0:STRIDE] = coeff10*tab_fun_u_derx[0:STRIDE] + coeff11*tab_fun_u_dery[0:STRIDE] + coeff12*tab_fun_u_derz[0:STRIDE];// + coeff13*shp[0:STRIDE];
		  temp[2][0:STRIDE] = coeff20*tab_fun_u_derx[0:STRIDE] + coeff21*tab_fun_u_dery[0:STRIDE] + coeff22*tab_fun_u_derz[0:STRIDE];// + coeff23*shp[0:STRIDE];
		  temp[3][0:STRIDE] = coeff30*tab_fun_u_derx[0:STRIDE] + coeff31*tab_fun_u_dery[0:STRIDE] + coeff32*tab_fun_u_derz[0:STRIDE] + coeff33*shp[0:STRIDE];
		  ...
		  temp[0][0:STRIDE] = el_data_in[offset2+0]*tab_fun_u_derx[0:STRIDE] + el_data_in[offset2+1]*tab_fun_u_dery[0:STRIDE] + el_data_in[offset2+2]*tab_fun_u_derz[0:STRIDE];// + el_data_in[offset2+12]*shp[0:STRIDE];
		  temp[1][0:STRIDE] = el_data_in[offset2+3]*tab_fun_u_derx[0:STRIDE] + el_data_in[offset2+4]*tab_fun_u_dery[0:STRIDE] + el_data_in[offset2+5]*tab_fun_u_derz[0:STRIDE]; //+ el_data_in[offset2+13]*shp[0:STRIDE];
		  temp[2][0:STRIDE] = el_data_in[offset2+6]*tab_fun_u_derx[0:STRIDE] + el_data_in[offset2+7]*tab_fun_u_dery[0:STRIDE] + el_data_in[offset2+8]*tab_fun_u_derz[0:STRIDE];// + el_data_in[offset2+14]*shp[0:STRIDE];
		  temp[3][0:STRIDE] = el_data_in[offset2+9]*tab_fun_u_derx[0:STRIDE] + el_data_in[offset2+10]*tab_fun_u_dery[0:STRIDE] + el_data_in[offset2+11]*tab_fun_u_derz[0:STRIDE] + el_data_in[offset2+15]*shp[0:STRIDE];
		  ...
		  temp[0][0:STRIDE] = coeff00*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_0 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_3 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_6) + coeff01*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_1 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_4 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_7) + coeff02*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_2 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_5 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_8); //+ coeff03*shape_fun_host[3*STRIDE*NGAUSS+igauss*STRIDE:STRIDE];
		  temp[1][0:STRIDE] = coeff10*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_0 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_3 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_6) + coeff11*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_1 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_4 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_7) + coeff12*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_2 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_5 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_8);//+ coeff13*shape_fun_host[3*STRIDE*NGAUSS+igauss*STRIDE:STRIDE];
		  temp[2][0:STRIDE] = coeff20*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_0 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_3 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_6) + coeff21*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_1 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_4 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_7) + coeff22*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_2 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_5 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_8); //+ coeff23*shape_fun_host[3*STRIDE*NGAUSS+igauss*STRIDE:STRIDE];
		  temp[3][0:STRIDE] = coeff30*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_0 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_3 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_6) + coeff31*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_1 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_4 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_7) + coeff32*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_2 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_5 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_8) + coeff33*shape_fun_host[3*STRIDE*NGAUSS+igauss*STRIDE:STRIDE];
		  ...
		  temp[0][0:STRIDE] = el_data_in[offset2+0]*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_0 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_3 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_6) + el_data_in[offset2+1]*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_1 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_4 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_7) + el_data_in[offset2+2]*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_2 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_5 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_8); //+ el_data_in[offset2+12]*shape_fun_host[3*STRIDE*NGAUSS+igauss*STRIDE:STRIDE];
		  temp[1][0:STRIDE] = el_data_in[offset2+3]*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_0 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_3 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_6) + el_data_in[offset2+4]*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_1 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_4 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_7) + el_data_in[offset2+5]*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_2 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_5 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_8); //+ el_data_in[offset2+13]*shape_fun_host[3*STRIDE*NGAUSS+igauss*STRIDE:STRIDE];
		  temp[2][0:STRIDE] = el_data_in[offset2+6]*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_0 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_3 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_6) + el_data_in[offset2+7]*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_1 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_4 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_7) + el_data_in[offset2+8]*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_2 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_5 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_8); //+ el_data_in[offset2+14]*shape_fun_host[3*STRIDE*NGAUSS+igauss*STRIDE:STRIDE];
		  temp[3][0:STRIDE] = el_data_in[offset2+9]*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_0 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_3 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_6) + el_data_in[offset2+10]*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_1 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_4 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_7) + el_data_in[offset2+11]*(shape_fun_host[igauss*STRIDE:STRIDE]*jac_2 + shape_fun_host[STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_5 + shape_fun_host[2*STRIDE*NGAUSS+igauss*STRIDE:STRIDE]*jac_8) + el_data_in[offset2+15]*shape_fun_host[3*STRIDE*NGAUSS+igauss*STRIDE:STRIDE];
...
#pragma simd
    ...
    /*kbw
    	...
    	for (jdof=0;jdof<NDOFS;jdof++) {
    	  printf("%20.12lf",stiff_mat[idof+jdof*NSHAP]);
    	}
    	printf("\n");
          }
          printf("Element %d: Rhs_vect:\n",ielem);
          for (idof=0;idof<NDOFS;idof++) {
    	printf("%20.12lf",load_vec[idof]);
          }
          printf("\n");
          getchar();
    /*kew*/
