...
/*---------------------------------------------------------
pdr_heat_err_indi_explicit - to return error indicator for an element
  // NOT IMPLEMENTED 
----------------------------------------------------------*/
double pdr_heat_err_indi_explicit(	
                             /* returns error indicator for an element */
  int Problem_id, 
  int El	/* in: element number */
    )
{
  printf("Explicit error indicator not implemented! Change problem parameters.\n");
  exit(0);
  return (0.0);
}
