...
kernel void tmr_ocl_num_int_el(
  ...
  //gdy jest constatnt to nie pasuje
...
//	  if(ielem==0&&group_id==0&&ipart==0&&igauss==0)
//	  {
//		  printf("thread_id=%d,jdof=%d,fun_u_derx=%lf,fun_u_dery=%lf,fun_u_derz=%lf,coeff00=%lf,coeff01=%lf,coeff02=%lf\n",thread_id,jdof,fun_u_derx,fun_u_dery,fun_u_derz,coeff00,coeff01,coeff02);
//	  }
  #else // if not USE_WORKSPACE_FOR_SHAPE_FUN
...
//	  if(ielem==0&&group_id==0&&ipart==0&&igauss==0)
//		{
//		  printf("thread_id=%d,jdof=%d,temp4=%lf\n",thread_id,jdof,temp4);
//		}
...
//		  if(ielem==0&&group_id==0&&ipart==0&&igauss==0)
//			{
//			  printf("thread_id=%d,jdof=%d,idof=%d,temp4=%lf\n",thread_id,jdof,idof,temp4);
//			}

   		//if(ielem==0&&group_id==0&&ipart==0&&igauss==0)
		//	printf("thread_id=%d,aux_offset=%d,ipart=%d,nr_parts=%d,jdof=%d,idof=%d,i=%d\n",thread_id,aux_offset,ipart,nr_parts,jdof,idof,i);
...
//-------------------------------------------------------------
//	if(igauss==0 && group_id==0 && ielem==0 && ipart==0 && thread_id<=129 && thread_id>=127)
//	{
//	  printf("thread_id=%d, idof=%d, jdof=%d, temp4=%lf,fun_v_derx=%lf, vol=%lf \n", thread_id, idof,jdof, temp4,fun_v_derx,jac[9]);
