...
// DEFINITIONS DEPENDENT ON OPTIMIZATION OPTIONS
  ...
  SCALAR load_vec[num_shap_pad/8];
#endif
...
//not for dg
  ...
  #ifdef LOAD_VEC_COMP
    for(i = 0; i < num_shap_pad/8; i++) load_vec[i] = zero;
  #endif
...
//     double4 num_shape_der[num_shap_pad];
 //    double4 tempv[num_shap_pad];
//     double4 res;


     for(int idof2 = 0; idof2 < num_shap_pad/8; idof2++){
...
//	  num_shape_der[idof].s0 = fun_u_derx;
//	  num_shape_der[idof].s1 = fun_u_dery;
//	  num_shape_der[idof].s2 = fun_u_derz;
//	  num_shape_der[idof].s3 = shp_fun_u;
...
// ************************* second loop over shape functions ****************************//
        ...
        for(int jdof2 = 0; jdof2 < num_shap_pad/8; jdof2++){
