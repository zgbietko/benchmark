...
// DEFINITIONS DEPENDENT ON OPTIMIZATION OPTIONS
  ...
  #define WORKSPACE_SIZE_FOR_STIFF_MAT ((num_shap_pad/WORK_GROUP_SIZE)*(num_shap_pad+1))
#else
...
//tu zmiana!!
	...
	workspace[3*idof]   = temp1*jac_0+temp2*jac_3+temp3*jac_6;
	workspace[3*idof+1] = temp1*jac_1+temp2*jac_4+temp3*jac_7;
	workspace[3*idof+2] = temp1*jac_2+temp2*jac_5+temp3*jac_8;
	//barrier(CLK_LOCAL_MEM_FENCE);
#ifdef COUNT_OPER
