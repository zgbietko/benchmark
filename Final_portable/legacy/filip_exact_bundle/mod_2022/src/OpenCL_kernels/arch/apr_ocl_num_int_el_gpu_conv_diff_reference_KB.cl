...
SCALAR nr_global_access=0.0;
...
#ifdef COUNT_OPER
 nr_oper += 14; // after optimization? (from assembler)
#endif
...
#ifdef COUNT_OPER
 nr_oper += 16+36; // after optimization?
 // total: 14 + 18*num_geo_dofs + 52 = 174 (for prisms)
#endif
...
#ifdef COUNT_OPER
 nr_oper += 4*7/6+9; // after optimization?
 // total: 14+18*num_geo_dofs+52+15*num_shap+4*7*num_shap+9*num_shap*num_shap =
 //          = 174+90+4*7*6+9*6*6 = 756 (for prisms) (with shape_fun_workspace)
#endif
 ...
 // total: 756+54 = 810 (for prisms) (with shape_fun_workspace)
#endif
