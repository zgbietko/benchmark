#########################################################################
#                                ModFEM                                 #
#               computerJB-CompilationTest-oldMPI.cmake                 #
#########################################################################
...
elseif(CMAKE_BUILD_TYPE STREQUAL "Debug") #Flags for debug mode
  ...
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -g3 -ggdb3")
...
set(VOROPP_INCLUDE_DIRS /usr/include/voro++)
set(VOROPP_LIBRARY_DIRS /usr/lib64)
...
set(OPENCL_LIBRARY_DIRS   /usr/lib /usr/lib64 /usr/local/cuda/lib64)
...
set(CREATE_MOD_FEM_CONV_DIFF_HYBRID_STD_QUAD TRUE)
set(CREATE_MOD_FEM_CONV_DIFF_PRISM2D_STD TRUE)
set(CREATE_MOD_FEM_CONV_DIFF_PRISM2D_STD_QUAD TRUE)
...
set(CREATE_MOD_FEM_HEAT_PRISM_STD_QUAD TRUE)
set(CREATE_MOD_FEM_HEAT_PRISM2D_STD TRUE)
set(CREATE_MOD_FEM_HEAT_PRISM2D_STD_QUAD TRUE)
set(CREATE_MOD_FEM_HEAT_HYBRID_STD TRUE)
set(CREATE_MOD_FEM_HEAT_HYBRID_STD_QUAD TRUE)
...
set(CREATE_MOD_FEM_LAPLACE_PRISM_STD_QUAD TRUE)
set(CREATE_MOD_FEM_LAPLACE_HYBRID_STD TRUE)
set(CREATE_MOD_FEM_LAPLACE_HYBRID_STD_QUAD TRUE)
set(CREATE_MOD_FEM_LAPLACE_PRISM2D_STD TRUE)
set(CREATE_MOD_FEM_LAPLACE_PRISM2D_STD_QUAD TRUE)
...
# ------------------------------ ELAST ---------------------------------#
set(CREATE_MOD_FEM_ELAST_PRISM_STD TRUE)
set(CREATE_MOD_FEM_ELAST_HYBRID_STD TRUE)
set(CREATE_MOD_FEM_ELAST_PRISM2D_STD TRUE)
