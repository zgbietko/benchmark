                  ...
                  FILE *Interactive_output)
{
  ...
  case UTE_NOT_NEED_MATERIAL_DATABASE:
    ...
    pdv_ns_supg_problem.ctrl.dynamic_viscosity =
      utr_mat_get_material_by_matID(0)->atT_dynamic_viscosity[0];
...
//      fprintf(Interactive_output, "Error reading material file !!! Exiting\n");
//      config_destroy(&cfg);
//      exit(-1);
//      //return(EXIT_FAILURE);
//    }
...
//      Materials_db->material_data =
//	(pdt_ns_supg_material_data*) malloc(sizeof(pdt_ns_supg_material_data)*count);
...
//		Materials_db->material_data[i].Tfor_dynamic_viscosity =
//		  (double*) malloc(sizeof(double)*setting_length);
//		Materials_db->material_data[i].atT_dynamic_viscosity =
//		  (double*) malloc(sizeof(double)*setting_length);
//		Materials_db->material_data[i].dynamic_viscosity_num = setting_length;
//		for(j = 0; j < setting_length; ++j)
//		  {
//		    Materials_db->material_data[i].Tfor_dynamic_viscosity[j] =
//		      (double)config_setting_get_float_elem(
//					      config_setting_get_elem(setting, j), 0);
//		    Materials_db->material_data[i].atT_dynamic_viscosity[j]  =
//		      (double)config_setting_get_float_elem(
...
//		Materials_db->material_data[i].atT_dynamic_viscosity[0]  =
...
//    /*   { */
//    /*     setting_length = config_setting_length(setting); */
//    /*     Materials_db->material_data[i].Tfor_VOF =  */
//    /* 	  (double*) malloc(sizeof(double)*setting_length); */
//    /*     Materials_db->material_data[i].atT_VOF =  */
//    /* 	  (double*) malloc(sizeof(double)*setting_length); */
//    /*     Materials_db->material_data[i].VOF_num = setting_length; */
//    /*     for(j = 0; j < setting_length; ++j) */
//    /*     { */
//    /*       Materials_db->material_data[i].Tfor_VOF[j] =  */
//    /* 	    (double)config_setting_get_float_elem( */
//    /*                                   config_setting_get_elem(setting, j), 0); */
//    /*       Materials_db->material_data[i].atT_VOF[j]  =  */
//    /* 	    (double)config_setting_get_float_elem( */
//    /*                                   config_setting_get_elem(setting, j), 1); */
//    /*     } */
//    /*   } */
...
//    /*     Materials_db->material_data[i].atT_VOF[0]  =  */
//    /* 	  (double)config_setting_get_float(setting);         */
//    /*   }   */
//    /* } */
//    /* 	else{ */
...
//    /* 	} */
//    /* 	if(NULL != (setting = config_setting_get_member(material, "dg_dT"))){ */
...
//    /*     Materials_db->material_data[i].Tfor_dg_dT =  */
//    /* 	  (double*) malloc(sizeof(double)*setting_length); */
//    /*     Materials_db->material_data[i].atT_dg_dT =  */
//    /* 	  (double*) malloc(sizeof(double)*setting_length); */
//    /*     Materials_db->material_data[i].dg_dT_num = setting_length; */
//    /*     for(j = 0; j < setting_length; ++j) */
//    /*     { */
//    /*       Materials_db->material_data[i].Tfor_dg_dT[j] =  */
//    /* 	    (double)config_setting_get_float_elem( */
//    /*                                config_setting_get_elem(setting, j), 0); */
//    /*       Materials_db->material_data[i].atT_dg_dT[j]  =  */
//    /* 	    (double)config_setting_get_float_elem( */
//    /*                                config_setting_get_elem(setting, j), 1); */
//    /*     } */
//    /*   } */
...
//    /*     //printf("\n\tAS: setting_length dg_dT = %d",  */
//    /* 	//                    Materials_db->material_data[i].dg_dT_num); */
//    /*     Materials_db->material_data[i].Tfor_dg_dT =  */
//    /* 	  (double*) malloc(sizeof(double)); */
//    /*     Materials_db->material_data[i].atT_dg_dT =  */
//    /* 	  (double*) malloc(sizeof(double)); */
//    /*     Materials_db->material_data[i].Tfor_dg_dT[0] = -1.0; */
//    /*     Materials_db->material_data[i].atT_dg_dT[0]  =  */
//    /* 	  (double)config_setting_get_float(setting); */
//    /*   } */
...
//    /* 	  (double*) malloc(sizeof(double)); */
//    /*     Materials_db->material_data[i].Tfor_dg_dT[0] = -1.0; */
//    /*     Materials_db->material_data[i].atT_dg_dT[0]  = 0.0; */
...
//    /* } */
//    /* 	else{Materials_db->material_data[i].temp_solidus  = 0.0;} */
...
//      if(constant_viscosity==1 && constant_density==1 && no_other_parameters==1 && count==1){
	
//	// we do not need material database
//	pdv_ns_supg_problem.ctrl.ref_temperature = -1.0;
//	pdv_ns_supg_problem.ctrl.dynamic_viscosity =
//	  Materials_db->material_data[0].atT_dynamic_viscosity[0];
//	pdv_ns_supg_problem.ctrl.density =
