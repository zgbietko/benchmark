...
//************************* JACOBIAN TERMS CALCULATIONS *************************//
    ...
    vol[:] = weight_linear_tetra;	// vol = weight CONSTANT FOR TETRA!!!
	...
	temp9[:] = zero;
	SCALAR daux[STRIDE] __attribute__((aligned(ALIGN)));
...
#pragma vector aligned
  #pragma ivdep
    ...
    printf("\nEXECUTION TIME: Numerical integration inside function2 %lf\n",
	   t_end_in-t_begin_in);
