...
if(thread_id<num_shap)
{
	...
	temp1 = shpfun_ref[igauss*4*num_shap+num_shap+thread_id];
	temp2 = shpfun_ref[igauss*4*num_shap+2*num_shap+thread_id];
	temp3 = shpfun_ref[igauss*4*num_shap+3*num_shap+thread_id];
...
//****** SUBSTITUTING OR COMPUTING GLOBAL DERIVATIVES OF IDOF SHAPE FUNCTION ******//
	  ...
	  // read proper values of shape functions and their derivatives
	  SCALAR shp_fun_u = shpfun_ref[igauss*4*num_shap+jdof];
	  temp1 = shpfun_ref[igauss*4*num_shap+num_shap+jdof];
	  temp2 = shpfun_ref[igauss*4*num_shap+2*num_shap+jdof];
	  temp3 = shpfun_ref[igauss*4*num_shap+3*num_shap+jdof];
...
//****** SUBSTITUTING OR COMPUTING GLOBAL DERIVATIVES OF JDOF SHAPE FUNCTION ******//
	...
	// read proper values of shape functions and their derivatives
	SCALAR shp_fun_v = shpfun_ref[igauss*4*num_shap+idof];;
	temp1 = shpfun_ref[igauss*4*num_shap+num_shap+idof];
	temp2 = shpfun_ref[igauss*4*num_shap+2*num_shap+idof];
	temp3 = shpfun_ref[igauss*4*num_shap+3*num_shap+idof];
