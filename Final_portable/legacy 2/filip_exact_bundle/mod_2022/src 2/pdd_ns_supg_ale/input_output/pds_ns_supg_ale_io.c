/************************************************************************
File pds_ns_supg_ale_problem_io.c - problem data read

Contains definition of routines:
  pdr_ns_supg_ale_dump_data - to write mesh and field data to files 
...
/*------------------------------------------------------------
pdr_ns_supg_ale_dump_data
------------------------------------------------------------*/
int pdr_ns_supg_ale_dump_data(
  char* Work_dir,
...
)
{
  ...
  /* if (utr_io_export_field(pdv_ns_supg_problem.ctrl.field_id, apr_get_nreq(pdv_ns_supg_problem.ctrl.field_id), 0, sigdigs, arg) < 0)	//!TODO its 7 not 0 in supg */
