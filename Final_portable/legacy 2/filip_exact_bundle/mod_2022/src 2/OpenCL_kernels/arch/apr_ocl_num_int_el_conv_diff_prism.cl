...
SCALAR nr_global_access=0.0;
  ...
  SCALAR shape_fun_workspace[SHAPE_FUN_WORKSPACE_SIZE];
  #else
 ...
 // total: 8+18*num_geo_dofs+15+36 = 167 (for prisms)
#endif
 ...
 // total: 13+5+18*num_geo_dofs+15+36+15*num_shap = 167+90 = 257 (for prisms)
#endif
 ...
 // total: 13+5+18*num_geo_dofs+15+36+15*num_shap = 177+90 = 267 (for prisms)
 // total: 8+18*num_geo_dofs+15+36+15*num_shap = 167+90 = 257 (for prisms)
#endif
 ...
 // (8+18*num_geo_dofs+15+36+15*num_shap+(7*4*num_shap+9)*num_shap+9*num_shap)*num_gauss =
 //          = (167+90+177*6+9*6)*6 = (257+1008+54)*6 = 8238 (for prisms) (with shape_fun_workspace)
 // 7914 WITHOUT RHS
