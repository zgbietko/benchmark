...
def run_pointer_latency(
    ...
    print("=== GPU pointer-chasing latency benchmark (OpenCL) ===")
    ...
    with csv_path.open("a", newline="") as f:
        ...
        for kb in sizes_kb:
            ...
            for run_idx in range(runs_per_size):
                ...
                elapsed_s = opencl_pointer_chase_latency(ocl, n=n, iters=iters_inner)
...
def main() -> None:
    ap = argparse.ArgumentParser(description="GPU pointer-chasing latency benchmark (OpenCL).")
