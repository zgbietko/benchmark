...
def main() -> None:
    ...
    summary = {
        ...
        "mode_label": "Native FEM performance campaign",
    ...
    try:
        diag_plots = generate_optimization_diagnostics(out_dir)
        if diag_plots:
            summary["plots"] = diag_plots
    except Exception as e:
        summary["optimization_diagnostics_error"] = str(e)
    summary_path.write_text(json.dumps(summary, indent=2, ensure_ascii=True), encoding="utf-8")
