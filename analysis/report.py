...
def main() -> None:
    ...
    if args.with_plots:
        ...
        sections.append(f"- exit_code: `{rc}`")
        sections.append("```text\n" + txt.strip() + "\n```")
        sections.append("Generated images (if matplotlib available):")
        sections.append("- `analysis/plots/gpu_bandwidth_vs_size.png`")
        sections.append("- `analysis/plots/gpu_pointer_latency.png`")
        sections.append("- `analysis/plots/cpu_stream_triad_vs_size.png`")
        sections.append("- `analysis/plots/real_kernels_overview.png`")
